...
> "I think I have figured it out through the flipbooks you have posted."
...
*Are you an educator, but content is not appropriate for your course?  Learn more about building your own flipbooks with {flipbookr} [here](https://evamaerey.github.io/flipbooks/about){target="_blank"}*.
...
*The "grammar of graphics" has helped data visualizers to understanding and use the deep connections between chart types. ggplot2 is a popular implementation of the grammar of graphics.  "A {ggplot2} grammar guide" is designed to orient you to organization (grammar if you will) of this particular implementation. * 
