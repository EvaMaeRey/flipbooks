...
source("00_paquetes_setup_tema.R") 

### Cargar funciones ----
source("01_funciones_limpieza_bd.R")

### Definir cortes de datos ----
subtitulo <- str_c("Cifras a las 19:00 hrs. del ", lubridate::day(Sys.Date())," de marzo de 2020 (CDMX)")
...
# Automático
datos_diarios <- 
  read_csv("../04_datos_generados/reporte_diario_por_pais/reporte_diario_por_pais_2020_03_23.csv")

# Serie de tiempo
source("04_preparar_datos_series_de_tiempo.R")
