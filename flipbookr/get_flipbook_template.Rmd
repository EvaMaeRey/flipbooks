...
py_url <- "https://raw.githubusercontent.com/EvaMaeRey/flipbookr/master/inst/rmarkdown/templates/python-flipbook/skeleton/skeleton.Rmd"

download.file(url = py_url, "py_skeleton.Rmd")
```
