...
Additionally, I'm rked on and testing materials to help people create their own books with minimal hassle.  A guide exists in the [A flipbook minimal example](https://evamaerey.github.io/little_flipbooks_library/tidytuesday_minimal_example/tidytuesday_minimal_example){target="_blank"} and the [The checkerboard example](https://evamaerey.github.io/little_flipbooks_library/checkerboard/checkerboard.html){target="_blank"}.  In a June 2019 workshop participants at the University of Illinois, successfully produced their own flipbook using the minimal example as a guide.  

These should no longer be used - instead, use the flipbookr package template [A minimal Flipbook](https://evamaerey.github.io/little_flipbooks_library/flipbookr/skeleton#1){target="_blank"}n this phase, research assistance from DU masters student Ryan Granier was extremely valuable in helping to move the project forward.  Thanks Ryan!
