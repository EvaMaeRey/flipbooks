...
2. Install flipbookr - `devtools::install_github("EvaMaeRey/flipbookr")` 
3. restart RStudio
...
Once you have completed steps 1-3, you can also follow along with the [live demo](https://resources.rstudio.com/rstudio-conf-2020/flipbooks-evangeline-reynolds) that I presented at the RStudio Conference, 2020 (the demo is at 6'25"). 
...
Flipbooks are inspired and enabled by the step-by-step workflow of ggplot2 and other tidyverse tools when using the magrittr pipe, and the knitr/rmarkdown communication tools.  Specifically we are using the rmarkdown slide show presentation tool, `Xaringan`, which is built on the [remark.js](https://yihui.org/en/2017/08/why-xaringan-remark-js/).  
