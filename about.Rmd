...
*Flipbooks* present code step-by-step and side-by-side with its output. The incremental code/result reveal may help you digest longer manipulation and analysis pipelines as well as plot builds.  Two of their attractive features is the incrementalism and the movie-like presentation.  
...
I've sorted the flipook I've created into three categories. You can link to a able of contents from here:  

### [Data Wrangling](https://evamaerey.github.io/tidyverse_in_action/about){target="_blank"}
