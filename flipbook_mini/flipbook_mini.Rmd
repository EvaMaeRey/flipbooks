---
title: "A sudo-blogpost: toward embedding a Flipbook Mini in HTML"
author: "Gina Reynolds"
date: "March 21, 2020"
output: html_document
---

*Why sudo? I couldn't get this embedding technique to work yet with blogdown ...*
...
3. Also, Claus Wilke has noted that the flipbooks aspect ratio control needs some work -- which is really apparent in the flipbook mini and is also an issue on the {xaringan} platform.  This has been duely noted and is logged as an issue in the development package --- help welcome!  It's something that I thought I could address with allowing an out.width and out.height argument, but this hasn't worked so far.  I haven't worked on this problem for the minis at all yet 
